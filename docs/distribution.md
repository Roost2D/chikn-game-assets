...
This arrangement lets a consumer pin an immutable image release, host it on consumer-controlled infrastructure, cache it independently from JavaScript, and upgrade the engine without downloading the content again. Mirroring must retain the unmodified Chikn Community Asset Pack Non-Commercial Licence and applicable Asset Manifest; it creates no new rights.

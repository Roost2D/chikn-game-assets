...
await mkdir(resolve(release, 'runtime/reports'), { recursive: true });
await mkdir(resolve(release, 'runtime/docs'), { recursive: true });
await cp(resolve('manifests/rights-manifest.json'), resolve(release, 'runtime/rights-manifest.json'));
await cp(resolve('reports/source-runtime-lineage.json'), resolve(release, 'runtime/reports/source-runtime-lineage.json'));
await cp(resolve('README.md'), resolve(release, 'runtime/README.md'));
await cp(resolve('INTEGRATION.md'), resolve(release, 'runtime/INTEGRATION.md'));
await cp(resolve('docs/audio.md'), resolve(release, 'runtime/docs/audio.md'));
